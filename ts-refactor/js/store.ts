...
class Store extends EventTarget {
  ...
  constructor(private readonly storgeKey: string, private readonly players: Player[]) {
    super();
  }
  ...
  #getState() {
    ...
    return item ? JSON.parse(item) as GameState : ititialValue;
  }
